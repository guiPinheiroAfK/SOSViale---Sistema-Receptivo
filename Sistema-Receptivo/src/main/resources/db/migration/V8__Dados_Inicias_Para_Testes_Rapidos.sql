-- 1. MOTORISTAS (Removido 'telefone' que deu erro)
INSERT INTO motoristas (nome, cnh) VALUES
                                       ('João Silva', '12345678901'),
                                       ('Maria Santos', '98765432109');

-- 2. VEÍCULOS (Usando 'label' conforme seu erro de coluna e removendo 'tipo')
INSERT INTO veiculos (label, placa, capacidade) VALUES
('Mercedes Sprinter 515', 'ABC-1D23', 15),
('Toyota Corolla XEI', 'DEF-2G34', 4),
('Jeep Compass Longitude', 'GHI-3H45', 5);
